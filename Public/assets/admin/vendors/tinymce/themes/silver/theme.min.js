...
! function() {
    ...
    const Ve = e => e.dom.nodeName.toLowerCase(),
        ...
        ut = e => {
            ...
            return ct(Ie(t)).fold((() => o.body.contains(t)), (n = ut, s = dt, e => n(s(e))));
            var n, s
        },
        mt = () => gt(Ie(document)),
        gt = e => {
        ...
        yo = bo,
        xo = (y(co), y("iOS"), y(uo), y(mo), y(go), y(po), y(ho), y(fo), e => window.matchMedia(e).matches);
    let wo = Gt((() => ((e, t, o) => {
        const n = eo.browsers(),
            s = eo.oses(),
    ...
    const Ko = (e, t, o) => e.stype === Xo.Error ? t(e.serror) : o(e.svalue),
        ...
        gn = e => ({
            extract: (t, o) => {
                return n = e(o), s = e => ((e, t) => mn(e, y(t)))(t, e), n.stype === Xo.Error ? s(n.serror) : n;
                var n, s
            },
            toString: y("val")
        }),
    ...
    const Kr = e => {
        ...
        xa = (e, t) => ((e, t) => {
            ...
            return o.errors.length > 0 ? (n = o.errors, qo.error(q(n))) : ((e, t) => 0 === e.length ? qo.value(t) : qo.value(sn(t, rn.apply(void 0, e))))(o.values, t);
            var n
        ...
        Ha = (e, t) => {
            const {
                ...
                toSet: r,
                toRemove: a
            } = za(e.attributes, s), i = Bt(t), {
                toSet: l,
                toRemove: c
            } = za(e.styles, i), d = (e => Oa(e) ? (e => {
                ...
                return o
            })(e) : _a(e))(t), u = J(d, e.classes), m = J(e.classes, d);
            return N(a, (e => xt(t, e))), ft(t, r), Ma(t, m), Aa(t, u), N(c, (e => At(t, e))), Ct(t, l), e.innerHtml.fold((() => {
            ...
            const o = () => m,
                ...
                c = ((e, t) => {
                    const o = t.filter((t => Ve(t) === e.tag && !(e => e.innerHtml.isSome() && e.domChildren.length > 0)(e) && !(e => ve(e.dom, la))(t))).bind((t => ((e, t) => {
                        ...
                        const t = De(e.tag);
                        ft(t, e.attributes), Ma(t, e.classes), Ct(t, e.styles), e.innerHtml.each((e => Wr(t, e)));
                        const o = e.domChildren;
                        return Mo(t, o), e.value.each((e => {
                            Fa(t, e)
                        })), t
                    })(e)));
                    return ea(o, e.uid), o
            ...
            const s = e.bubble,
                ...
                h = p ? c : ((e, t) => {
                    const {
                        ...
                        width: l,
                        height: c
                    } = e, d = Math.max(o, s - l), u = Math.max(n, r - c), m = Ri(a, o, d), g = Ri(i, n, u), p = Math.min(m + l, s) - m, h = Math.min(g + c, r) - g;
                    return Lo(m, g, p, h)
                })(c, a),
                        ...
                        const a = t => {
                            ...
                            i = r => {
                                if (m(r) || a(r)) {
                                    ...
                                    (m(a) || a === js()) && (clearTimeout(s), xt(e, jl), Aa(e, t.classes))
                                }
                            },
                            l = Nl(e, Gs(), (t => {
    ...
    var ad = Object.freeze({
        ...
        reset: (e, t, o, n) => {
            const s = n.element;
            N(["position", "left", "right", "top", "bottom"], (e => At(s, e))), (e => {
                xt(e, Dl)
            })(s), o.clear(n.uid)
        }
    });
    const id = ul({
        ...
        _d = (e, t, o) => {
            ...
            kt(e.element, "position", id.getMode(n)), ((e, t, o, n) => {
                Et(e.element, t).fold((() => {
                    xt(e.element, o)
                }), (t => {
                    ht(e.element, o, t)
        ...
        Td = (e, t, o) => {
            (e => V(["top", "left", "right", "bottom"], (t => Et(e, t).isSome())))(e.element) || At(e.element, "position"), ((e, t, o) => {
    ...
    const ym = ul({
        ...
        xm = (e, t, o, n) => {
            ...
            N(s, (o => {
                V(n, (e => e.element === o)) || (Ea(o, t.highlightClass), e.getSystem().getByDom(o).each((o => {
        ...
        eg = e => {
            const t = [Qn("onEscape"), Qn("onEnter"), is("selector", '[data-alloy-tabstop="true"]:not(:disabled)'), is("firstTabstop", 0), is("useTabstopAt", T), Qn("visibilitySelector")].concat([e]),
                ...
                s = (e, t, n, s) => {
                    ...
                    return ((e, t) => t.focusManager.get(e).bind((e => ti(e, t.selector))))(e, n).bind((t => $(r, S(Ge, t)).bind((t => ((e, t, n, s, r) => r(t, n, (e => ((e, t) => o(e, t) && e.useTabstopAt(t))(s, e))).fold((() => s.cyclic ? B.some(!0) : B.none()), (t => (s.focusManager.set(e, t), B.some(!0)))))(e, r, t, n, s)))))
                },
    ...
    var tg = eg(Wn("cyclic", _)),
        og = eg(Wn("cyclic", T));
    const ng = (e, t, o) => om(o) && Um(Im)(t.event) ? B.none() : ((e, t, o) => (kr(e, o, Qs()), B.some(!0)))(e, 0, o),
        sg = (e, t) => B.some(!0),
    ...
    const dg = e => (t, o, n, s) => {
        ...
        pg = (e, t, o, n, s) => n.focusManager.get(t).bind((o => e(t.element, o, n, s))).map((e => (n.focusManager.set(t, e), !0))),
        hg = gg,
        fg = gg,
        bg = gg,
        ...
        Cp = (e, t) => {
            wl((() => {
                ((e, t, o) => {
                    ...
                    (e => {
                        N(e.components(), (e => Do(e.element))), Ao(e.element), e.syncComponents()
                    })(e);
                    const s = o(t),
                        r = J(n, s);
                    N(r, (t => {
    ...
    var Wp = Object.freeze({
        ...
        Up = Object.freeze({
            ...
            exhibit: () => ha({}),
            events: (e, t) => {
                const o = (n = e, s = t, r = Np, Nr((e => {
                    r(e, n, s)
                })));
                var n, s, r;
                const a = al(e, t, Lp);
                return _r(q([e.toggleOnExecute ? [o] : [],
                    [a]
                ]))
            }
        });
    ...
    const qp = () => {
        ...
        lh = [jn("uid"), jn("data"), jn("components"), jn("dom"), is("autofocus", !1), is("ignoreFocus", !1), ou("widgetBehaviours", [Zd, Hp, kp]), is("domModification", {}), qu(ih()), wi("builder", (e => {
            const t = Hu(ah(), e, ih()),
                ...
                s = (t, o) => om(o.event.target) ? B.none() : e.autofocus ? (o.setSource(t.element), B.none()) : B.none();
            return {
                dom: e.dom,
                components: o,
                domModification: e.domModification,
                ...
                behaviours: nu(e.widgetBehaviours, [Zd.config({
                    ...
                    onLeft: s,
                    onRight: s,
                    onEscape: (t, o) => Hp.isFocused(t) || e.autofocus ? e.autofocus ? (o.setSource(t.element), B.none()) : B.none() : (Hp.focus(t), B.some(!0))
                })])
            }
        }))],
        ch = Nn("type", {
        ...
        yh = em({
            ...
            factory: (e, t) => {
                const o = Hl(),
                    ...
                    a = (e, t) => {
                        Bm.highlight(e, t), Bm.getHighlighted(t).orThunk((() => Bm.getFirst(t))).each((t => {
                            kr(e, t.element, er())
                        }))
                    },
                    ...
                    d = (t, o, n) => B.from(n[0]).bind((s => o.lookupMenu(s).bind((s => {
                        if ("notbuilt" === s.type) return B.none(); {
                            ...
                            })), ut(r.element) || Dp.append(t, $a(r)), Aa(r.element, [e.markers.backgroundMenu]), a(t, r), l(t, o, n), B.some(r)
                        }
                    }))));
                let u;
                ! function(e) {
                ...
                const m = (t, o, r = u.HighlightSubmenu) => {
                        if (o.hasConfigured(ym) && ym.isDisabled(o)) return B.some(o); {
                            const a = s(o);
                            return n.expand(a).bind((s => (c(t, s), B.from(s[0]).bind((a => n.lookupMenu(a).bind((i => {
                                const l = ((e, t, o) => {
                                    if ("notbuilt" === o.type) {
                    ...
                    g = (t, o) => {
                        const r = s(o);
                        return n.collapse(r).bind((s => (c(t, s), d(t, n, s).map((n => (e.onCollapseMenu(t, o, n), n))))))
                    },
                    ...
                    h = _r([Br(mh(), ((e, t) => {
                        ...
                        t.getSystem().getByDom(n).each((o => {
                            0 === s(o).indexOf("collapse-item") && g(t, o), m(t, o, u.HighlightSubmenu).fold((() => {
                                e.onExecute(t, o)
                            }), b)
                        }))
                    })), zr(((t, o) => {
            ...
            factory: (e, t) => {
                const o = (e, t, o, s) => {
                    ...
                    n = (t, o, n, s) => {
                        ...
                        Dd.openWhileCloaked(t, o, (() => id.positionWithinBounds(r, t, n, s()))), Zd.setValue(t, B.some({
                            mode: "position",
                            config: n,
                            getBounds: s
                        }))
                    ...
                    s = (t, o, n, s) => {
                        const r = ((e, t, o, n, s) => {
                            ...
                            return yh.sketch({
                                ...
                                onEscape: () => (Dd.close(t), e.onEscape.map((e => e(t))), B.some(!0)),
                                onExecute: () => B.some(!0),
                                onOpenMenu: (e, t) => {
                                ...
                                onRepositionMenu: (e, t, n) => {
                                    const a = r().getOrDie();
                                    id.positionWithinBounds(a, t, o, s()), N(n, (e => {
                ...
                return {
                    ...
                    behaviours: tu(e.inlineBehaviours, [Dd.config({
                        ...
                        channels: { ...zd({
                            ...
                            ...Pd({ ...e.fireRepositionEventInstead.map((e => ({
                                    fireEventInstead: {
                                        event: e.event
                                    }
                                }))).getOr({}),
    ...
    var Vh, zh, Hh = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    ...
    const jf = "tox-menu-nav__js",
        ...
        dv = [Rb, Tb, Ab, ("menuitem", Ln("value", "value", an((() => Kr("menuitem-value"))), On())), Hb];
                        ...
                        t.resetTimer((() => {
                            (o => {
                                if (!t.isShowing()) {
                                    ...
                                    t.setTooltip(s), pd(n, s), e.onShow(o, s), id.position(n, s, {
                                        anchor: e.anchor(o)
                                    })
                                }
                            })(o)
    ...
    const Dv = (e, t) => {
        ...
        Fv = (e, t) => {
            ...
            })), e.on("SwitchMode", (() => Dv(t, e.mode.isReadOnly()))), jh(e) && e.mode.set("readonly")
        },
        Iv = () => hl.config({
            channels: {
                [Mv]: {
        ...
        jv = (e, t, o, n) => {
            ...
            return {
                ...
                itemBehaviours: cl([Fp("item-events", [Lv(e, o), Pv(e, s), Nv(e, s)]), (r = () => !e.enabled || n.isDisabled(), ym.config({
                    disabled: r,
    ...
    const Ay = "tinymce-custom-colors",
        ...
        Ky = (e, t, o, n, s, r, a) => we(P(e, (i => {
            return "choiceitem" === i.type ? (l = i, Vn("choicemenuitem", mv, l)).fold(ub, (l => B.some(((e, t, o, n, s, r, a, i = !0) => {
                const l = ey({
                    presets: o,
                ...
                return {
                    ...
                    components: [sy.widget({
                        ...
                        behaviours: cl([Fp("insert-table-picker", [zr((e => {
                            ...
                            ((e, t, o, n, s) => {
                                for (let n = 0; n < 10; n++)
                                    for (let s = 0; s < 10; s++) $p.set(e[n][s], n <= t && s <= o)
    ...
    const rx = (e, t, o, n, s) => {
            ...
            switch (e.type) {
                case "menuitem":
                    return (i = e, Vn("menuitem", bv, i)).fold(ub, (e => B.some(((e, t, o, n = !0) => {
                        const s = ey({
                            presets: "normal",
                            iconContent: e.icon,
                            textContent: e.text,
                ...
                case "nestedmenuitem":
                    return (e => Vn("nestedmenuitem", vv, e))(e).fold(ub, (e => B.some(((e, t, o, n = !0, s = !1) => {
                        const r = s ? (a = o.icons, qv("chevron-down", a, [Yf])) : (e => qv("chevron-right", e, [Yf]))(o.icons);
                        var a;
                        const i = ey({
                            presets: "normal",
                            iconContent: e.icon,
        ...
        ax = (e, t, o, n, s, r, a) => {
            ...
            return we(P(e, (e => {
                switch (e.type) {
                    case "separator":
                        return (n = e, Vn("Autocompleter.Separator", Wb, n)).fold(ub, (e => B.some(nx(e))));
                    case "cardmenuitem":
        ...
        cx = (e, t) => {
            ...
            ((e, t) => {
                ...
                t.on("keydown", (t => {
                    const s = t.which;
                    e.isActive() && (e.isMenuOpen() ? 13 === s ? (n().each(Sr), t.preventDefault()) : 40 === s ? (n().fold((() => {
                ...
                n = (e => {
                    const t = Hl(),
                        ...
                        s = ys([{
                            ...
                            key: Bs(),
                            value: s => (n.cancel(), t.get().filter((e => Ge(e.target, s.target))).map((t => o.get() ? (s.prevent(), !1) : e.triggerEvent(tr(), s))))
                        }]);
                    return {
        ...
        fx = (e, t, o, n, s, r) => {
            ...
            return a.fold((() => (r.logEventNoHandlers(t, n), hx.complete())), (e => {
                const o = e.descHandler;
                return fa(o)(i), i.isStopped() ? (r.logEventStopped(t, e.element, o.purpose), hx.stopped()) : i.isCut() ? (r.logEventCut(t, e.element, o.purpose), hx.complete()) : Je(e.element).fold((() => (r.logNoParent(t, e.element, o.purpose), hx.complete())), (n => (r.logEventResponse(t, e.element, o.purpose), hx.resume(n))))
            }))
        },
    ...
    const Bx = (e, t, o, n) => {
        ...
        tw = (e, t) => {
            ...
            Ea(o, t.invalidClass), t.notify.each((t => {
                ew(e.element) && ht(e.element, "aria-invalid", !1), t.getContainer(e).each((e => {
                    Wr(e, t.validHtml)
                })), t.onValid(e)
            }))
        },
        ow = (e, t, o, n) => {
            ...
            Ta(s, t.invalidClass), t.notify.each((t => {
                ew(e.element) && ht(e.element, "aria-invalid", !0), t.getContainer(e).each((e => {
                    Wr(e, n)
                })), t.onInvalid(e, n)
            }))
        },
        ...
        sw = (e, t, o) => (t.notify.each((t => {
            t.onValidate(e)
        })), nw(e, t).map((o => e.getSystem().isConnected() ? o.fold((o => (ow(e, t, 0, o), qo.error(o))), (o => (tw(e, t), qo.value(o)))) : qo.error("No longer in system"))));
        ...
        bw = (e, t, o, n, s, r, a) => {
            const i = ((e, t, o, n, s, r, a) => {
                const i = ((e, t, o) => (0, e.fetch)(o).map(t))(e, t, n),
                    l = xw(n, e);
                return i.map((e => e.bind((e => B.from(yh.sketch({ ...r.menu(),
                    uid: oa(""),
                    data: e,
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: tu(e.dropdownBehaviours, [$p.config({
                        ...
                        onEscape: (e, t) => Tw.isOpen(e) ? (Tw.close(e), B.some(!0)) : B.none()
                    }), Hp.config({})]),
                    events: Xp(B.some((t => {
            ...
            factory: (e, t, o, n) => {
                const s = t => Lu(t, e, "thumb"),
                    ...
                    p = t => {
                        ...
                        e.mouseIsDown.set(!1), o && Nu(t, e, "thumb").each((o => {
                            const n = d.value.get();
                            e.onChoose(t, o, n)
                        }))
                    },
                ...
                store: {
                    ...
                    getValue: t => {
                        ...
                        return ce(o, ((e, t) => e().bind((e => {
                            return o = rm.getCurrent(e), n = new Error(`Cannot find a current component to extract the value from for form part '${t}': ` + jr(e.element)), o.fold((() => qo.error(n)), qo.value);
                            var o, n
                        })).map(Zd.getValue)))
                    },
                    setValue: (t, o) => {
                        ...
                        const s = {
                            ...
                            g = (e, t) => {
                                ...
                                (e => "hex" === e.type)(n) ? ((e, t) => {
                                    ...
                                    d(t, B.some(n)), c("red").bind((e => c("green").bind((t => c("blue").map((o => by(e, t, o, 1))))))).each((t => {
                                        const o = ((e, t) => {
                                            const o = uy(t);
    ...
    const wC = ul({
        ...
        TC = y([Tu({
            ...
            overrides: e => ({
                ...
                onHover: (t, o) => {
                    e.previewing.set(!1), t.getSystem().getByUid(e.uid).each((t => {
                        e.model.populateFromBrowse && SC(e.model, t, o)
                    }))
                }
            })
        ...
        EC = tm({
            ...
            factory: (e, t, o, n) => {
                const s = (t, o, s) => {
                        ...
                        if (Dd.isOpen(r)) rm.getCurrent(r).each((e => {
                    ...
                    i = [Hp.config({}), Zd.config({
                                ...
                                const r = t => {
                                    rm.getCurrent(s).each((t => {
                                        o.fold((() => {
                                            ...
                                            Bm.highlightBy(t, (t => Zd.getValue(t).value === e.value)), Bm.getHighlighted(t).orThunk((() => (Bm.highlightFirst(t), B.none())))
                                        }))
                                    }))
                                };
                        ...
                        onEnter: t => {
                            const o = mw.getCoupled(t, "sandbox"),
                                n = Dd.isOpen(o);
                            if (n && !e.previewing.get()) return rm.getCurrent(o).bind((e => Bm.getHighlighted(e))).map((e => (wr(t, OC(), {
                                item: e
                            }), !0))); {
                                const s = Zd.getValue(t);
                                return xr(t, sr()), e.onExecute(o, t, s), n && Dd.close(o), B.some(!0)
                            }
                        }
                    }), $p.config({
        ...
        QC = {
                        ...
                        behaviours: cl([ym.config({
                            ...
                            onSetValue: (o, n) => {
                                ((o, n) => {
                                    ...
                                    Wr(o.element, a.join(""))
                                })(o, n), "auto" === e.columns && xv(o, 5, "tox-collection__item").each((({
                                    numRows: e,
                                    numColumns: t
                                }) => {
            ...
            button: ZC(((e, t) => ((e, t) => {
                ...
                return n = B.none(), s = Cx.parts.field({
                    factory: Sh,
                    ...
                    coupledFieldBehaviours: cl([ym.config({
                        ...
                        o = ((e, t) => {
                            ...
                            return Se(o, n, ((e, t) => gC(e, t.unit).map((e => t.value / e)).map((e => {
                                return o = e, n = t.unit, e => gC(e, n).map((e => ({
                                    value: e * o,
                                    unit: n
                                })));
                                var o, n
            ...
            urlinput: ZC(((e, t, o) => ((e, t, o, n) => {
                        ...
                        fetch: n => {
                            const s = ((e, t, o) => {
                                    ...
                                    return o.getLinkInformation().fold((() => []), (t => {
                                        ...
                                        return "file" === e ? (r = [n, XC(s, jC(t)), XC(s, q([$C(t), GC(t), qC(t)]))], j(r, ((e, t) => 0 === e.length || 0 === t.length ? e.concat(t) : e.concat(NC, t)), [])) : n;
                                        var r
                                    }))
                                })(e.filetype, n, o),
                ...
                return Cx.sketch({
                    ...
                    components: i.toArray().concat([{
                        ...
                        components: q([
                            [m.asSpec()], d.map((() => g.asSpec())).toArray()
                        ])
                    }]),
                    fieldBehaviours: cl([ym.config({
                        disabled: () => !e.enabled || s.isDisabled(),
                ...
                return {
                    ...
                    behaviours: cl([Ok(), Dk(a, (() => o.get()), ((e, t) => {
                        ...
                        n.getOpt(e).each((o => {
                            const n = o.element;
                            var s;
                            t.url !== bt(n, "src") && (ht(n, "src", t.url), Ea(e.element, "tox-imagepreview__loaded")), u(r.cachedWidth) || u(r.cachedHeight) || a(), (s = n, new Promise(((e, t) => {
                                const o = () => {
                                        r(), e(s)
                                    },
        ...
        oO = (e, t, o, n) => be(QC, t.type).fold((() => (console.error(`Unknown factory type "${t.type}", defaulting to container: `, t), t)), (s => s(e, t, o, n))),
        nO = "layout-inset",
        sO = e => e.x,
    ...
    const __ = e => (xe(Et(e, "position"), "fixed") ? B.none() : Qe(e)).orThunk((() => {
        ...
        R_ = (e, t, o) => {
            o.setDocked(!1), N(["left", "right", "top", "bottom", "position"], (t => At(e.element, t))), t.onUndocked(e)
        },
        V_ = (e, t, o, n) => {
        ...
        H_ = (e, t, o) => {
            e.getSystem().isConnected() && ((e, t, o) => {
                ...
                o.isDocked() && z_(e, t, o, n), I_(e, n, o).each((s => {
    ...
    const U_ = ul({
        ...
        K_ = e => {
            ...
            Je(t).each((o => {
                ...
                if (U_.isDocked(e)) {
                    const e = Ut(o);
                    kt(t, "width", e + "px"), kt(o, n, (e => Vt(e) + (parseInt(_t(e, "margin-top"), 10) || 0) + (parseInt(_t(e, "margin-bottom"), 10) || 0))(t) + "px")
        ...
        Z_ = (e, t) => {
            const o = Hl(),
                ...
                r = t => {
                    e.inline || K_(t), J_(e, U_.isDocked(t)), t.getSystem().broadcastOn([Id()], {}), n().each((e => e.getSystem().broadcastOn([Id()], {})))
                },
            ...
            return [Hp.config({}), U_.config({
                contextual: {
                    ...
                    onShown: e => {
                        s((e => Aa(e, [G_.transitionClass, G_.fadeInClass]))), o.get().each((t => {
                            ((e, t) => {
                                const o = qe(t);
                    ...
                    onHide: e => {
                        ((e, t) => xl(e).orThunk((() => t().toOptional().bind((e => xl(e.element))))))(e.element, n).fold(o.clear, o.set), s((e => Y_(e, !1)))
                    },
                    onHidden: () => {
        ...
        OT = (e, t) => {
            const o = t => ju(e),
                ...
                a = n(((e, t) => {
                    if (s(e)) {
                        const o = e.element;
                        kt(o, "display", "none"), ht(o, "aria-hidden", "true"), wr(e, hr(), {
                            name: t,
                            visible: !1
                        })
                    }
            ...
            const c = n(((e, t) => {
                    if (!s(e)) {
                        const o = e.element;
                        At(o, "display"), xt(o, "aria-hidden"), wr(e, hr(), {
                            name: t,
                            visible: !0
                        })
                    }
    ...
    var RT = Object.freeze({
            ...
            block: (e, t, o, n) => {
                ...
                Dp.append(s, $a(i)), i.hasConfigured(kp) && t.focus && kp.focusIn(i), o.isBlocked() || t.onBlock(e), o.blockWith((() => Dp.remove(s, i)))
            },
            unblock: (e, t, o) => {
    ...
    const zT = ul({
        ...
        NT = (e, t, o) => {
            const n = fs(!1),
                ...
                r = o => {
                    var s;
                    n.get() && (!(e => "focusin" === e.type)(s = o) || !(s.composed ? oe(s.composedPath()) : B.from(s.target)).map(Ie).filter(He).exists((e => Ba(e, "mce-pastebin")))) && (o.preventDefault(), PT(t()), e.editorManager.setActive(e))
                };
                ...
                s !== n.get() && (n.set(s), ((e, t, o, n) => {
                    ...
                    if (((e, t) => {
                            ...
                            B.from(e.iframeElement).map(Ie).each((e => {
                                t ? (vt(e, o).each((t => ht(e, n, t))), ht(e, o, -1)) : (xt(e, o), vt(e, n).each((t => {
                                    ht(e, o, t), xt(e, n)
                                })))
                            }))
                        })(e, o), o) zT.block(t, (e => (t, o) => ({
                        dom: {
                            tag: "div",
                            attributes: {
                    ...
                    }))(n)), At(s, "display"), xt(s, "aria-hidden"), e.hasFocus() && PT(t);
                    else {
                        const o = rm.getCurrent(t).exists((e => vl(e.element)));
                        zT.unblock(t), kt(s, "display", "none"), ht(s, "aria-hidden", "true"), o && e.focus()
                    }
        ...
        tE = tm({
            ...
            factory: (e, t, o, n) => ({ ...Sh.sketch({ ...n.button(),
                    action: e => {
                        ZT(e, n)
                    },
                    buttonBehaviours: nu({
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: tu(e.splitToolbarBehaviours, [mw.config({
                        others: {
                            overflowGroup: () => sE.sketch({ ...n["overflow-group"](),
                                items: [s.asSpec()]
                            })
                        }
                    })]),
        ...
        cE = y([_u({
            ...
            overrides: e => ({
                toolbarBehaviours: cl([wT.config({
                    ...
                    mode: "acyclic",
                    onEscape: t => (Nu(t, e, "overflow-button").each(Hp.focus), B.some(!0))
                })])
            })
        }), Tu({
            name: "overflow-button",
        ...
        mE = tm({
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: tu(e.splitToolbarBehaviours, [mw.config({
                        others: {
                            overflowGroup: e => sE.sketch({ ...n["overflow-group"](),
                                items: [Sh.sketch({ ...n["overflow-button"](),
                                    action: t => {
                                        xr(e, s)
                                    }
                                })]
        ...
        factory: (e, t, o) => {
            const n = {
                ...
                toggleToolbarDrawer: t => {
                    m_.getPart(t, e, "toolbar").each((e => {
                        var t, o;
                        o = t => t(e), null != (t = e.getApis().toggle) ? B.some(o(t)) : B.none()
                    }))
                },
    ...
    const EE = {
        ...
        RE = (e, t) => {
            const o = Tf(t);
            o && t.contentCSS.push(o + (e ? "/content.inline" : "/content") + ".min.css"), !Of(t) && r(o) ? Promise.all([FE(t, o), IE(t, o)]).then(AE(t), ((e, t) => () => ((e, t) => e.dispatch("SkinLoadError", t))(e, {
    ...
    const $E = (e, t, o) => {
            const n = (s = ((e, t) => t === GE.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(e.options.get(t), o), P(s, (e => {
                let t = e,
                    o = e;
                const n = e.split("=");
    ...
    const cB = ul({
        ...
        _B = {
            ...
            splitbutton: OB((e => Vn("SplitButton", sT, e)), ((e, t) => ((e, t) => {
                const o = Kr("channel-update-split-dropdown-display"),
                    n = e => ({
                        ...
                        setActive: t => {
                            ht(e.element, "aria-pressed", t), ei(e.element, "span").each((o => {
            ...
            grouptoolbarbutton: OB((e => Vn("GroupToolbarButton", eT, e)), ((e, t, o) => {
                ...
                if ( of (o) === Vh.floating) return ((e, t, o, n) => {
                    const s = t.shared;
                    return tE.sketch({
                        lazySink: s.getSink,
                        fetch: () => Jx((t => {
        ...
        EB = (e, t, o, n) => {
            const s = (e => {
                ...
                a = P(s, (s => {
                    const r = X(s.items, (s => 0 === s.trim().length ? [] : ((e, t, o, n, s, r) => be(t, o.toLowerCase()).orThunk((() => r.bind((e => re(e, (e => be(t, e + o.toLowerCase()))))))).fold((() => be(TB, o.toLowerCase()).map((t => t(e, s))).orThunk((() => B.none()))), (t => "grouptoolbarbutton" !== t.type || n ? ((e, t, o) => be(_B, e.type).fold((() => (console.error("skipping button defined by", e), B.none())), (n => B.some(n(e, t, o)))))(t, s, e) : (console.warn(`Ignoring the '${o}' toolbar button. Group toolbar buttons are only supported when using floating toolbar mode and cannot be nested.`), B.none()))))(e, t.buttons, s, t.allowToolbarGroups, o, n).toArray()));
                    return {
    ...
    var DB = Object.freeze({
        ...
        render: (e, t, o, n, s) => {
            ...
            ((e, t) => {
                xd(e, t, To)
            })(i, t.mothership), yd(l, t.uiMothership), e.on("PostRender", (() => {
                BB(e, t, o, n), r.set(e.getWin().innerWidth), TE.setMenubar(a, ME(e, o)), TE.setSidebar(a, o.sidebar, Cf(e)), ((e, t) => {
                    const o = e.dom;
                    let n = e.getWin();
            ...
            Fv(e, t), e.addCommand("ToggleSidebar", ((t, o) => {
    ...
    var NB = Object.freeze({
        ...
        render: (e, t, o, n, s) => {
            const {
                ...
                uiMothership: a,
                outerContainer: i
            } = t, l = fs(null), c = Ie(s.targetNode), d = ((e, t, o, n, s) => {
                const {
                    uiMothership: r,
                    outerContainer: a
                } = o, i = Hh.DOM, l = If(e), c = zf(e), d = Kh(e).or(VB(e)), u = n.shared.header, m = u.isPositionedAtTop, g = of (e), p = g === HB.sliding || g === HB.floating, h = fs(!1), f = () => h.get() && !e.removed, b = e => p ? e.fold(y(0), (e => e.components().length > 1 ? Rt(e.components()[1].element) : 0)) : 0, v = () => {
                    r.broadcastOn([Id()], {})
                }, x = (e = !1) => {
                    if (f()) {
                        if (l || (() => {
            ...
            const m = () => {
                ...
                const s = Rf(e);
                yd(s, r), yd(s, a), BB(e, t, o, n), TE.setMenubar(i, ME(e, o)), d.show(), ((e, t, o, n) => {
                    const s = fs(PB(t, o.isPositionedAtTop())),
                        r = n => {
                            const {
                                pos: r,
                                bounds: a
                            } = PB(t, o.isPositionedAtTop()), {
                                pos: i,
                                bounds: l
                    ...
                    const a = zl();
                    a.set(Ll(Ie(e.getBody()), "load", r)), e.on("remove", (() => {
                        a.clear()
                    }))
    ...
    const LB = "contexttoolbar-hide",
        ...
        JB = (e, t, o, n) => {
            const s = t => (n, s, r, a, i) => ({ ...YB(e, a, t, o, i)({ ...n,
                        y: i.y,
                        height: i.height
                    }, s, r, a, i),
                    alwaysFit: !0
        ...
        rM = (e, t, o, n) => {
            const s = n.backstage,
                ...
                d = Ga((e => {
                    ...
                    return xh.sketch({
                        ...
                        inlineBehaviours: cl([Fp("context-toolbar-events", [Vr(js(), ((e, t) => {
                            ...
                            const s = Ut(o);
                            kt(o, "width", n + "px"), xh.getContent(e).each((e => {
                                t.event.focus.bind((e => (bl(e), xl(o)))).orThunk((() => (kp.focusIn(e), yl(it(o)))))
                            })), setTimeout((() => {
                            ...
                            mode: "special",
                            onEscape: o => ne(t.get()).fold((() => e.onEscape()), (e => (xr(o, tM), B.some(!0))))
                        })]),
                        lazySink: () => qo.value(e.sink)
                    })
                })({
                    sink: o,
                    onEscape: () => (e.focus(), B.some(!0))
                })),
                u = () => {
                ...
                h = () => {
                    if (xh.isOpen(d)) {
                        const e = d.element;
                        At(e, "display"), g() ? kt(e, "display", "none") : (l.set(0), xh.reposition(d))
                    }
                },
                f = t => ({
                    dom: {
                ...
                y = t => {
                    const {
                        buttons: o
                    } = e.ui.registry.getAll(), s = { ...o,
                        ...v().formNavigators
                    }, a = of (e) === Vh.scrolling ? Vh.scrolling : Vh.default, i = q(P(t, (t => "contexttoolbar" === t.type ? ((t, o) => EB(e, {
                        buttons: t,
                        toolbar: o.items,
                        allowToolbarGroups: !1
                ...
                x = (t, n) => {
                    ...
                    c.set(p), l.set(1);
                    const b = d.element;
                    At(b, "display"), (e => xe(Se(e, i.get(), Ge), !0))(n) || (Ea(b, sM), id.reset(o, d)), xh.showWithinBounds(d, f(s), {
                        anchor: h,
                        transition: {
                            classes: [sM],
                            mode: "placement"
                        }
                    }, (() => B.some(u()))), n.fold(i.clear, i.set), g() && kt(b, "display", "none")
                },
                w = bC((() => {
                    e.hasFocus() && !e.removed && (Ba(d.element, sM) ? w.throttle() : ((e, t) => {
                        ...
                        return (e => !n(e) && !$e(o, e))(s) ? B.none() : ((e, t, o) => {
                            ...
                            if (n.contextForms.length > 0) return B.some({
                                ...
                                const t = ZB(e, o);
                                if (t.contextForms.length > 0) return B.some({
                                    elem: e,
                            ...
                            if (He(e)) {
                                const {
                                    contextToolbars: t,
                                    contextForms: n
                                } = ZB(e, o.inNodeScope), s = n.length > 0 ? n : (e => {
                                    if (e.length <= 1) return e; {
            ...
            e.on("init", (() => {
                e.on("remove", p), e.on("ScrollContent ScrollWindow ObjectResized ResizeEditor longpress", h), e.on("click keyup focus SetContent", w.throttle), e.on(LB, p), e.on("contexttoolbar-show", (t => {
                    const o = v();
                    ...
                    ((e, t, o, n, s, r, a) => {
                        ...
                        oC(o, Uf.CLOSE_ON_EXECUTE, n, !0).map((o => {
                            t.preventDefault(), xh.showMenuWithinBounds(s, {
                                ...
                                data: o,
                                type: "horizontal"
                            }, (() => B.some($B(e, n.shared, "node" === r ? "node" : "selection")))), e.dispatch(LB)
                        }))
                    })(e, t, a, n, s, r, !(c || i || l && d))
                };
            if ((l || i) && "node" !== r) {
        ...
        zM = (e, t, o) => {
            const n = So().deviceType.isTouch,
                ...
                a = e => xh.hide(s),
                i = t => {
                    if (yM(e) && t.preventDefault(), ((e, t) => t.ctrlKey && !yM(e))(e, t) || (e => 0 === wM(e).length)(e)) return;
                    const a = ((e, t) => {
                        const o = xM(e),
        ...
        sA = e => {
            (e => {
                Je(e.element).filter(He).each((e => {
                    vt(e, oA).fold((() => At(e, "z-index")), (t => kt(e, "z-index", t))), xt(e, oA)
                }))
                ...
                ((e, t, o, n) => {
                    ...
                    if (t.repositionTarget) {
                        const r = qe(e.element),
                            ...
                            i = T_(s),
                            l = (e => {
                                return (t = Et(e, "left"), o = Et(e, "top"), n = Et(e, "position"), s = (e, t, o) => ("fixed" === o ? KM : qM)(parseInt(e, 10), parseInt(t, 10)), t.isSome() && o.isSome() && n.isSome() ? B.some(s(t.getOrDie(), o.getOrDie(), n.getOrDie())) : B.none()).getOrThunk((() => {
                                    const t = Nt(e);
                            ...
                            c = ((e, t, o, n, s, r, a) => ((e, t, o, n, s) => {
                                ...
                                const e = (t = o, a = r.left, i = r.top, t.fold(((e, t) => qM(e + a, t + i)), ((e, t) => XM(e + a, t + i)), ((e, t) => KM(e + a, t + i))));
                                var t, a, i;
                                const l = WM(e, n, s);
    ...
    const SA = gl({
        ...
        _A = (e, t) => {
            ...
            So().deviceType.isTouch() && (e.on("TableSelectionChange", (e => {
                s.get() || (pd(t, g), pd(t, p), s.set(!0)), r.set(e.start), a.set(e.finish), e.otherCells.each((t => {
        ...
        TA = (e, t, o) => {
            ...
            return {
                ...
                behaviours: cl([kp.config({
                    ...
                    e.shortcuts.add("alt+F11", "focus statusbar elementpath", (() => kp.focusIn(t))), e.on("NodeChange", (n => {
                        const r = (t => {
                                const o = [];
                                let n = t.length;
                                for (; n-- > 0;) {
    ...
    const BA = (e, t, o) => {
        ...
        AA = (e, t) => ({
            ...
            components: (() => {
                const o = (() => {
                        const o = [];
                        return xf(e) && o.push(TA(e, {}, t)), e.hasPlugin("wordcount") && o.push(((e, t) => {
        ...
        FA = e => {
            ...
            return {
                ...
                renderUI: () => {
                    ...
                    })(e, v, x), n.setup(e, f.shared, m), fM(e, f), zM(e, g, f), (e => {
                        const {
                            sidebars: t
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: tu(e.modalBehaviours, [Dp.config({}), kp.config({
                        ...
                        })(t.element, Lu(t, e, "title").element), ((e, t) => {
        ...
        _F = (e, t, o) => {
            Za(e, '[role="dialog"]').each((e => {
                ei(e, '[role="tablist"]').each((n => {
                    o.get().map((o => (kt(t, "height", "0"), kt(t, "flex-basis", "0"), Math.min(o, ((e, t, o) => {
                        const n = Ke(e).dom,
        ...
        MF = (e, t, o) => {
                    ...
                    const t = (() => {
                        const t = Hl(),
                            o = [zr((o => {
                                const n = o.element;
                                TF(n).each((s => {
                                    kt(s, "visibility", "hidden"), o.getSystem().getByDom(s).toOptional().each((o => {
                                ...
                                TF(n).each((e => {
                                    ...
                                    s.forall((e => r > e)) ? (t.set(r), _F(n, e, t)) : s.each((t => {
                                        OF(e, t)
            ...
            return CF.sketch({
                ...
                }), Dk(B.none(), (e => (e.getSystem().broadcastOn([EF], {}), n.get())), ((e, t) => {
        ...
        QF = e => j(e, ((e, t) => "menu" === t.type ? j(t.items, ((e, t) => (e[t.name] = t.storage, e)), e) : e), {}),
                ...
                s = {
                    ...
                    redial: o => {
                        n((n => {
                            const r = e.getId(),
                                a = t(o);
                            n.getSystem().broadcastOn([`${AF}-${r}`], a), n.getSystem().broadcastOn([`${DF}-${r}`], a.internalDialog), n.getSystem().broadcastOn([`${FF}-${r}`], a.internalDialog), n.getSystem().broadcastOn([`${IF}-${r}`], a.internalDialog), s.setData(a.initialData)
                        }))
                    },
                    close: () => {
                        n((e => {
            ...
            getNotificationManagerImpl: () => ((e, t, o) => {
                ...
                return {
                    open: (t, r) => {
                        ...
                        o.add(l), t.timeout > 0 && wh.setEditorTimeout(e, (() => {
                            a()
                        }), t.timeout);
                        const c = {
                            close: a,
