/*! jquery.avgrund - v1.3.3 (http://labs.voronianski.com/jquery.avgrund.js) */ ! function(a) {
    ...
    $.fn.avgrund = function(a) {
        ...
        return a = $.extend(b, a), this.each(function() {
            ...
            function e() {
                return "function" != typeof a.onClosing || a.onClosing(f) ? (g.unbind("keyup", b).unbind("click", c).removeClass("avgrund-active"), setTimeout(function() {
                    $(".avgrund-popin").remove()
                }, 500), "function" == typeof a.onUnload && a.onUnload(f), void 0) : !1
            }
            var f = $(this),
                g = $("body"),
