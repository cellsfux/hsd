...
<head>
  ...
  <link rel="stylesheet" href="<?= URLROOT ?>assets/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" type="text/css" href="<?= URLROOT ?>assets/admin/js/select.dataTables.min.css">
...
<body class="with-welcome-text sidebar-dark">
  ...
  <script src="<?= URLROOT ?>assets/admin/vendors/chart.js/Chart.min.js"></script>
  <script src="<?= URLROOT ?>assets/admin/vendors/progressbar.js/progressbar.min.js"></script>
  ...
  <script src="<?= URLROOT ?>assets/admin/js/jquery.cookie.js" type="text/javascript"></script>
  <script src="<?= URLROOT ?>assets/admin/js/dashboard.js"></script>
  <script src="<?= URLROOT ?>assets/admin/js/Chart.roundedBarCharts.js"></script>


  <script src="<?= URLROOT ?>assets/admin/vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="<?= URLROOT ?>assets/admin/vendors/datatables.net/dataTables.bootstrap4.js"></script>
  <script src="<?= URLROOT ?>assets/admin/js/data-table.js"></script>
