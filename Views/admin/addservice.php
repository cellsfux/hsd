    ...
    <div class="content-wrapper">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="cmxform" id="form-submit" data-url="<?= URLROOT ?>admin/addActionServices" method="post" action="#">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label for="curl">URL vers la vidéo</label>
      ...
      <div style="width:100%; display:flex; padding-top:5px; align-items:center; justify-content:center">
           <img  id="image_preview"  style="width: 70%;"  >
                      ...
                      <div class="form-group">
                      <h4 class="card-title">description du service</h4>
