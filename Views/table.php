...
<body class="with-welcome-text sidebar-dark">
  ...
  <script src="<?= URLROOT ?>assets/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  ...
  <script src="<?= URLROOT ?>assets/admin/vendors/sweetalert/sweetalert.min.js"></script>
  <script src="<?= URLROOT ?>assets/admin/vendors/jquery.avgrund/jquery.avgrund.min.js"></script>
  <script src="<?= URLROOT ?>assets/admin/js/alerts.js"></script>
  <script src="<?= URLROOT ?>assets/admin/js/avgrund.js"></script>
  ...
  <script>
      ...
      $(document).ready(()=>{
        $('.swal-button--confirm').click(()=>alerte('okokokoko'))
      })
  </script>
